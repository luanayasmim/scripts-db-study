...
# Aula 20/09/2021
# Aprendendo sobre atualização de dados (DML)
#UPDATE tbl_filme SET nome_filme = 'O Espetacular Homem Aranha' WHERE id_filme=10;
#UPDATE tbl_filme SET nome_filme = 'A Rua do Medo', ano_lancamento='2021' WHERE id_filme=30 OR id_filme=21;

#Aprendendo sobre exclusão de dados no banco
#DELETE FROM tbl_filme WHERE id_filme=10 OR id_filme=30 OR id_filme=21;

# Resetando a tabela
#TRUNCATE tbl_filme2; #Ele só permite quando não há chave estrangeira

#Lição de casa
UPDATE tbl_ator SET nome_ator='Elisabeth Olsen', sexo='F', dt_nascimento='1989/02/06' WHERE id_ator='18';
